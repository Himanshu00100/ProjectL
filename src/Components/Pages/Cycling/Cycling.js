    ...
    <main className='w-screen h-auto'>
      ...
      <div className='w-full px-[50px] py-[15px] 2k:px-[250px]'>
        <div className='w-full h-[24px] bg-white flex justify-start items-center gap-x-[9px] text-[13px] font-[500] '>
          ...
          <p className='font-[400]'>Cycling</p>
        </div>
      </div>
      ...
      <div className='px-[50px] 2k:px-[250px]'>
        <h1 className='text-[40px] leading-[40px] font-oswald font-[600] text-start mb-[20px] mt-[7px]'>Cycling</h1>
      </div>
          ...
          <div className='w-full 
            ...
            <div className='w-80%] 2xl:w-[20%] h-full bg-white product flex flex-col items-center 2xl:block'>
              ...
              <div className='w-full h-[50px] mt-[10px]  flex flex-col items-start gap-y-[5px] 2xl:gap-y-[0px] '>
                <a href='' className='hover:text-red-500 duration-200 text-[14px] font-[500]'>Minimalist backpack sports</a>
                <p>$90.00</p>
              </div>
            </div>
            {/* product 2  */}
            <div className='w-80%] 2xl:w-[20%] h-full bg-white product flex flex-col items-center 2xl:block'>
              ...
              {/* product price */}
              <div className='w-full h-[50px] mt-[10px]  flex flex-col items-start gap-y-[5px] 2xl:gap-y-[0px] '>
                <a href='' className='hover:text-red-500 duration-200 text-[14px] font-[500]'>Wristband cycling gloves</a>
                <p>$80.00</p>
              </div>
            </div>
            {/* product 3  */}
            <div className='w-80%] 2xl:w-[20%] h-full bg-white product flex flex-col items-center 2xl:block'>
              ...
              <div className='w-[268px] h-[357.25px]  cursor-pointer relative  overflow-hidden flex justify-center'>
                ...
                <Link to={"/cycling-accessory/cycling-kit-in-black"}>
                  <img src={p3} alt='Product 5' className='w-full' />
                </Link>
              </div>
              {/* product price */}
              <div className='w-full h-[50px] mt-[10px]  flex flex-col items-start gap-y-[5px] 2xl:gap-y-[0px] '>
                <a href='' className='hover:text-red-500 duration-200 text-[14px] font-[500]'>Cycling kit in black</a>
                <p>$240.00</p>
              </div>
            </div>
            {/* product 4 */}
            <div className='w-80%] 2xl:w-[20%] h-full bg-white product flex flex-col items-center 2xl:block'>
              ...
              <div className='w-[268px] h-[357.25px]  cursor-pointer relative  overflow-hidden flex justify-center'>
                ...
                <Link to={"/cycling-accessory/women-cycling-clothing"}>
                  <img src={p4} alt='Product 5' className='w-full' />
                </Link>
              </div>
              {/* product price */}
              <div className='w-full h-[50px] mt-[10px]  flex flex-col items-start gap-y-[5px] 2xl:gap-y-[0px] '>
                <a href='' className='hover:text-red-500 duration-200 text-[14px] font-[500]'>Women cycling clothing</a>
                <p>$75.00</p>
              </div>
            </div>
