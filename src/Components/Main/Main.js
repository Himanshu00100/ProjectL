  ...
  return (
    <>
      ...
      <main className=' flex-col w-screen  z-[-10] '>
        ...
        <div className='w-screen h-[151.600px]  px-[50px] mt-[80px] mb-[70px] hidden '>
          <h2 className='text-[30px] font-oswald font-[600] mb-[23px]'>SHOP BY CATEGORIES</h2>
          <div className='top w-full   h-[91.600px] border-gray-200 cursor-default flex justify-between items-center '>
