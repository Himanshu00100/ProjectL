...
import color1 from "../../../../Assets/training product pages/product 10/color1.jpg"
import color2 from "../../../../Assets/training product pages/product 10/color2.jpg"
import color3 from "../../../../Assets/training product pages/product 10/color3.jpg"
import color4 from "../../../../Assets/training product pages/product 10/color4.jpg"
import color5 from "../../../../Assets/training product pages/product 10/color5.jpg"
        ...
        <main className='w-screen h-auto pb-[50px]'>
            ...
            <div className='w-full px-[50px] py-[15px] 2k:px-[250px]'>
                <div className='w-full h-[24px] bg-white flex justify-start items-center gap-x-[9px] text-[13px] font-[500] '>
                    ...
                    <span className='text-[13px]  pt-[4px]'><FontAwesomeIcon icon={faAngleRight} /></span>
                    <p className='font-[400]'>Cropped tennis skirt</p>
                </div>
            </div>
            ...
            <div className='w-full h-auto px-[50px] 2k:px-[250px] flex flex-col mb-[85px]'>
                ...
                <div className='w-full h-auto flex '>
                    ...
                    <div className='w-[529.350px] h-[690.6px] font-[500] flex flex-col'>
                        ...
                        <h1 className='font-oswald font-[600] text-[40px] leading-[40px] text-start mb-[10px]'>CROPPED TENNIS SKIRT</h1>
                        {/* review */}
                        ...
                        <div className='flex flex-col mb-[30px] gap-y-[5px]'>
                            ...
                            <div className='w-full flex gap-x-[60px] text-start'>
                                ...
                                <span className=' text-[14px] font-[500] '>Supersport</span>
                            </div>
                            {/* product code */}
                            <div className='w-full flex gap-x-[15px] '>
                                <span className='text-[14px] font-[400] text-start'>Product code</span>
                                <span className=' text-[14px] font-[500] '>0089</span>
                            </div>
                            {/* In stock */}
                            <div className='w-full flex gap-x-[35px]'>
                                <span className='text-[14px] font-[400] text-start'>Availablity</span>
                                <span className=' text-[14px] font-[500] text-start'>12 in stock</span>
                            </div>
                        </div>

                        {/* price */}
                        <h1 className='text-[32px] leading-[1em] font-[700] text-start mb-[35px]'>$41.00</h1>
                        {/* divider */}
