...
const Header = () => {
    ...
    return (
        <>
                    ...
                    <div className='w-[1420.8px] h-[24px] bg-white flex justify-between'>
                        ...
                        <div className='flex justify-center items-center gap-x-5'>
                            ...
                            <div className="flex gap-x-[23px] text-[13px] font-semibold">
                                <a href=' #' className="hover:text-red-500 duration-200 " >About</a>
                                <a href=' #' className="hover:text-red-500 duration-200 " >Contact</a>
                                <a href=' #' className="hover:text-red-500 duration-200 " >Blog</a>
                                <a href=' #' className="hover:text-red-500 duration-200 " >Help</a>
                            </div>
            ...
            <header className=" z-20 hidden ">
                {/* header's top section starts from here */}
                <div className="hidden md:block w-full px-[50px] py-[8px] border-b-[1px] border-gray-200 ">
                    <div className="w-full h-[24px]  flex items-center justify-between">
                        ...
                        {/* socialmedia section ends from here */}
                            ...
                            <div className="flex gap-x-[20px] ">
                                <div className='lang flex justify-center items-center relative  '>
                                    <a href=' #' className=" text-sm hover:text-red-500 duration-200 flex justify-center items-center">
                                        ...
                                        <p>English</p>
                                        <FontAwesomeIcon icon={faAngleDown} className="ml-[3px] text-[11px]" />
                                        <div className='langdrop bg-white hover:text-black w-[145px] h-[80px]  absolute  top-[150%] border-[1px] border-black py-[10px] flex flex-col justify-center items-center gap-y-2 invisible none opacity-0 transition-all duration-[400ms]'>
                                            <a href=' #' className="flex justify-center items-center hover:text-red-500 duration-200 w-full" >
                                                <img src={espenol} alt='' className="mr-[8px] w-[18px] h-[12px]" />
                                                <p>English</p>
                                            </a>
                                ...
                                <div className='currency flex justify-center items-center hover:text-red-500 duration-200 '>
                                    ...
                                    <a href=' #' className=" text-sm hover:text-red-500 duration-200 relative">$ USD
                                        <FontAwesomeIcon icon={faAngleDown} className="ml-[3px] text-[11px]" />
                                        <div className="currencydrop bg-white hover:text-black w-[145px] h-[80px]  absolute right-0  top-[150%] border-[1px] border-black py-[10px] flex flex-col justify-center items-center gap-y-2 invisible none opacity-0 transition-all duration-[400ms]">
                                            <a href=' #' className="flex justify-center items-center hover:text-red-500 duration-200 w-full" >
                                                <p>€ EUR</p>
                                            </a>
                                            <a href=' #' className="flex justify-center items-center hover:text-red-500 duration-200 w-full" >
                ...
                {/* header's bottom section starts from here */}
                <div className={" navbar px-[50px] py-[20px] bg-white   " + navbarstatus}>
                    <div className="w-full h-[45.6px]  flex items-center">
                        <div className='logo'>
                        ...
                        <nav className='navbar w-[470.663px] h-[38px]  ml-[25px] flex justify-center items-center gap-x-[25px] '>
                            <div className=" shop relative flex justify-center keys cursor-pointer">
                                <p className="text-lg font-medium py-7">Shop</p>
                                <span className=" underline w-[1px] h-[0.7px] bg-black absolute bottom-[30px] transition-all duration-300 ease-in-out opacity-0   "></span>
                                ...
                                <div className="shopdrop w-[1536px] h-[460px] bg-white  absolute top-[83px] left-[-241.5px] border-t-[1px] border-gray-300 transition-[height] duration-[300ms] ease-out opacity-0 invisible ">
                                    ...
                                    <div className=' shopoverlay w-screen h-screen bg-black opacity-50 absolute top-0px]  z-[-20] transition-all duration-200 ease-in-out '></div>
                                </div>
                            </div>
                            ...
                            <div className="women relative flex justify-center keys cursor-pointer">
                                ...
                                <span className=" underline w-[1px] h-[0.7px] bg-black absolute bottom-[30px] transition-all duration-300 ease-in-out opacity-0   "></span>
                                {/* women's dropdown section starts from here */}
                                <div className='womendrop w-screen  h-[300px] absolute top-[83px] left-[-312px]  bg-white border-t-[1px] border-gray-200 px-[60px] pt-[50px] p-[40px] flex justify-center transition-[padding,height] duration-[300ms] ease-out opacity-0 invisible '>
                                    <div className='h-full w-full ' >
                                        <div className='w-full h-full  flex justify-center gap-x-[40px] '>
                                            ...
                                            <div className=' womenoverlay w-screen h-screen bg-black opacity-50 absolute top-0px]  z-[-20] transition-all duration-200 ease-in-out '></div>
                            ...
                            <div className="men relative flex justify-center keys cursor-pointer">
                                ...
                                <div className='mendrop w-screen  h-[300px] absolute top-[83px] left-[-404px] bg-white border-t-[1px] border-gray-200 px-[60px] pt-[50px] p-[40px] flex justify-center transition-[padding,height] duration-[300ms] ease-out opacity-0 invisible  '>
                                    <div className='h-full w-full ' >
                                        <div className='w-full h-full  flex justify-center gap-x-[40px] '>
                                            {/* special section starts from here */}
                                            <div className='w-[200px] h-[90%] flex flex-col'>
                                            ...
                                            <div className=' menoverlay w-screen h-screen bg-black opacity-50 absolute top-0px]  z-[-20] transition-all duration-200 ease-in-out '></div>
                            ...
                            <div className="accessory relative flex justify-center keys cursor-pointer">
                                <p className="text-lg font-medium py-7">Accessories</p>
                                <span className=" underline w-[1px] h-[0.7px] bg-black absolute bottom-[30px] transition-all duration-300 ease-in-out opacity-0   "></span>
                                <div className='accessorydrop flex bg-white w-screen  h-[333px] absolute top-[83px] left-[-467px]  border-t-[1px] border-gray-200 pl-[80px] px-[50px] py-[50px]  justify-center transition-[padding,height] duration-[300ms] ease-out  opacity-0 invisible '>
                                    <div className=' w-full h-full  flex flex-col gap-y-[10px] '>
                                        <div className='w-full h-[33.33%]  flex gap-x-[10px]'>
                                            <div className='w-[25%] h-full bg-gray-100 flex items-center pl-[20px] pr-[10px] py-[15px] gap-x-[20px]'>
                                                <img src={acfootball} alt='' className='w-[46px] h-[46px]' />
                                    ...
                                    <div className=' accessoryoverlay w-screen h-screen bg-black opacity-50 absolute top-[0px] left-[0]  z-[-20] transition-all duration-200 ease-in-out '></div>
                                </div>
                            </div>
                        ...
                        <div className='   pl-[20px] pr-[50px] py-[7px] bg-gray-100 ml-[350px] relative flex justify-center items-center'>
                            <input type="text" className="w-[158.400px] h-[30px] focus:outline-none bg-gray-100 text-sm flex justify-center items-center" placeholder='Search for products' />
                            <FontAwesomeIcon icon={faMagnifyingGlass} className='absolute right-[14px] text-lg' />
                        </div>
                        ...
                        <div className='profile flex gap-x-2 ml-10'>
                            <div className='user'>
                                <a href=' #' className=' relative'>
                                    <FontAwesomeIcon icon={faUserPlus} className="text-[20px] px-3 py-3 hover:text-red-500 duration-200" />
                                    <div className='userdrop absolute  bg-red-500'>
                            ...
                            <div className='cart'>
                                <a href=' #' className='cart flex justify-center relative'>
                                    <FontAwesomeIcon icon={faCartPlus} className="text-[20px] px-3 py-3 hover:text-red-500 duration-200" />
                                    {/* <div className='cartdrop absolute text-white bg-gray-600 text-nowrap text-sm left-[-70px] bottom-[-15px] px-1 py-[2px] border-[2px] border-white opacity-0 invisible none delay-[1s] ease-out duration-[300ms]'>
                                    View your shopping cart
                                </div> */}
                                </a>
