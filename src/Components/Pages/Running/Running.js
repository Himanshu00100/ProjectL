...
import { faAngleDown, faAngleRight, faChartBar, faCheck, faHeart, faMagnifyingGlass, faStar } from '@fortawesome/free-solid-svg-icons'

// running product images
import img1 from "../../Assets/running/product1.jpg"
import img2 from "../../Assets/running/product2.jpg"

const Running = () => {
    return (
        <>
            <main className='w-screen h-auto'>
                {/* home > Running section from here */}
                <div className='w-full px-[50px] py-[15px] 2k:px-[250px]'>
                    <div className='w-full h-[24px] bg-white flex justify-start items-center gap-x-[9px] text-[13px] font-[500] '>
                        ...
                        <p className='font-[400]'>Running</p>
                    </div>
                </div>
                {/* home > Running section ends here */}

                {/* Shop heading  */}
                <div className='px-[50px] 2k:px-[250px]'>
                    <h1 className='text-[40px] leading-[40px] font-oswald font-[600] text-start mb-[20px] mt-[7px]'>RUNNING</h1>
                </div>
                ...
                <div className='w-full h-auto px-[50px] pt-[15px] 2k:px-[250px]  mb-[80px]'>
                    <div className='w-full h-full bg-white flex flex-col'>
                        ...
                        <div className='w-full  2k:px-[250px] flex gap-x-[20px]'>
                            {/* product 1  */}
                            <div className='w-[80%] 2xl:w-[20%] h-full bg-white product'>
                                {/* product image 4*/}
                                <div className='w-full h-[357.25px] bg-white cursor-pointer relative  overflow-hidden flex justify-center'>
                                    ...
                                    <img src={img1} alt='Product 4' className='w-full' />
                                </div>
                                {/* product price */}
                                <div className='w-full h-[50px] mt-[10px]  flex flex-col items-start gap-y-[5px] '>
                                    <a href='' className='hover:text-red-500 duration-200 text-[14px] font-[500]'>Shorts high waist yoga</a>
                            ...
                            <div className='w-[80%]] 2xl:w-[20%] h-full bg-white product'>
                                ...
                                <div className='w-full h-[357.25px] bg-white cursor-pointer relative  overflow-hidden flex justify-center'>
                                    ...
                                    <img src={img2} alt='Product 5' className='w-full' />
                                </div>
                                {/* product price */}
                                <div className='w-full h-[50px] mt-[10px]  flex flex-col items-start gap-y-[5px] '>
                                    <a href='' className='hover:text-red-500 duration-200 text-[14px] font-[500]'>Lounge legging shorts</a>
                                    <p className='text-red-500'>$45.00</p>
                                </div>
                            </div>
